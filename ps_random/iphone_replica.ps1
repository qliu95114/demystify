...

{
    ...
    Write-UTCLog "Last Copy StartTime : $((get-date).ToUniversalTime().ToString("yyyy-MM-dd HH:mm:ss"))" -color "yellow"
    (get-date).ToUniversalTime().ToString("yyyy-MM-dd HH:mm:ss") | Out-File $lastcopyfile
